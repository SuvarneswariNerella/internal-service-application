                ...
                {stats.recentActivity.slice(0, 6).map((act) => {
                  const getIcon = () => {
                    switch (act.type) {
                      ...
                      case "PROJECT":
                        return <FolderKanban className="w-3.5 h-3.5 text-indigo-600" />;
                      case "SERVER":
                        return <Server className="w-3.5 h-3.5 text-sky-600" />;
                      case "DOMAIN":
                  ...
                  return (
                    <div key={act.id} className="p-2.5 rounded-lg border border-gray-100 bg-gray-50/60 hover:bg-gray-50 transition-colors flex items-start gap-2.5">
                      <div className="w-6 h-6 rounded-md bg-white border border-gray-200/60 shadow-xs flex items-center justify-center shrink-0 mt-0.5">
                        {getIcon()}
                      </div>
                      <div className="min-w-0 flex-1">
                        <div className="flex items-center justify-between gap-2 mb-0.5">
                          <span className="font-bold text-xs text-gray-900 truncate">{act.title}</span>
